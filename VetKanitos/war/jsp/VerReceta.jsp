...
<% List<Receta> recetas = (List<Receta>)request.getAttribute("VerReceta");%>
<!DOCTYPE html>
<html lang="en">
<head>
  	<title>MENU</title>
...
<div class="slider-container">
			<div class="mp-slider">
			<h2><center>LISTA DE RECETAS REGISTRADAS</center></h2>
		...
		<table id="t01" class= "table">
			...
			<tr>
				<td><a ><%= receta.getNumeroReceta()%></a></td>
				<td><%=receta.getId_cliente() %></td>
				<td><%= receta.getNombreMascota() %></td>
				<td><%= receta.getNombreMedico()%></td>
