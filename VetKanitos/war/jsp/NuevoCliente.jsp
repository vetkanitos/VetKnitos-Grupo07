...
<div class="slider-container">
		...
		<form action="/RegistrarCliente" method="post">
			<table>
				...
				<tr>
				<td>Ocupacion:</td>
					<td><input type="text" name="ocupacion" pattern="([a-zA-Záéíóú]+[\s]*[a-zA-Záéíóú]*)"></td>
					<td>Direccion:</td>
				...
				<tr>
				<td>Email *:</td>
					<td><input type="email" name="email" placeholder="ejemplo@ejemplo.com" required pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="Ingrese un email correcto"></td>
