...
<div class="slider-container">
			<div class="mp-slider">
			<h2><center>RbUSQUEDA DE UNA MASCOTA </center></h2>
		
				<div class="9u skel-cell-important">
						<section>
							<header>
								<h2>Busqueda por ID de dueño </h2><br><br>
								
								<h3>Ingrese el id por favor</h3> <br><br>
								<input type="text" id="idbusqueda"><br><br>
								<input type="submit" >							
							</header>
						 </section>
</div>
