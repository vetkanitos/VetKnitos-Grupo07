...
<html>
<head>
<title>BUSQUQEDA DE HISTORIAS</title>
  	<meta charset="utf-8">
...
<div class="slider-container">
			<div class="mp-slider">
			<h2><center>REGISTRO BUSCAR HISTORIAS CLINICAS </center></h2>

		<form action="/BuscarHistoria" method="post">
			...
			<fieldset>
				...
				<table>
					<tr>
						...
						<td><input type="text" name="dni_cliente" maxlength="8" 
							pattern="[0-9]{8}" title="Ingrese solo numeros">
						<td> <input
							type="submit" name="action" value="dni_cliente"></td>
					</tr>
				</table>
			</fieldset>
				...
				<table>
					<tr>
						...
						<td><select name="medico">
								...
								<option value="<%= medico.getNombre() %>">
								<%= medico.getNombre() %></option>
								<%}%>
						</select></td>
						<td>
						
						<input type="submit" name="action" value="medico"></td>
					</tr>
				</table>
			</fieldset>
