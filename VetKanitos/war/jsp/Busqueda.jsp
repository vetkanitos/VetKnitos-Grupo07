...
<body id="page1">
	...
	<div class="slider-container">
		<div class="mp-slider">
			<h2>
				<center>BUSQUEDA POR DNI DEL DUEÑO</center>
			</h2>

			<div class="9u skel-cell-important">
				<section>
						<form action="/BuscarMascota" method="post">
							<h3>Ingrese el DNI_DUEÑO por favor</h3>
							<input type="text" name="dni_cliente" maxlength="8"
								pattern="[0-9]{8}" title="Ingrese solo numeros">
							<input type="submit" name="action" value="dni_cliente"></td>
						</form>
				</section>
			</div>
		</div>
