...
<% List<Cliente> clientes = (List<Cliente>)request.getAttribute("VerCliente");%>    
...
<div class="slider-container">
        <div class="mp-slider">
        <br>
        <h2><center>LISTA DE LOS CLIENTES</center></h2>
						<hr>
						<table id="t01" class="table">
							...
							<tr>
								...
								<td><%=cliente.getApellidop()%> <%=cliente.getApellidom()%>,
									<%=cliente.getNombre()%></td>
