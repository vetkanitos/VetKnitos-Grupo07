...
<% List<Administrador> administrador = (List<Administrador>)request.getAttribute("verAdministrador");%> 
...
<div class="slider-container">
        <div class="mp-slider">
        <br>
        <h2><center>LISTA DE LOS ADMINISTARDORES</center></h2>
    ...
    Administrador admi = (Administrador)administrador.get(i);%>
	<tr>
