...
<div class="slider-container">
			<div class="mp-slider">
			<h2><center>HISTORIA CLINICA ENCONTRADAS POR DNI </center></h2>
		
	<div class="body">
		<h2>Historias encontradas por DNI</h2>
		<hr>
		<table>
		<tr>
		<td>DNI:</td>
		<td><input type="text" value="<%= request.getAttribute("dni")%>"></td>
		</tr>
		</table>
		<br>
    ...
    Historia h = (Historia)historias.get(i);%>
			
			<tr>
				<td><a href="verHistoria.jsp"><%= h.getNumero() %></a></td>
				<td><%= h.getMedico() %></td>
