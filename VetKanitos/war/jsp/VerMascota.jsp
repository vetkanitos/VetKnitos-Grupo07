...
<% List<Mascota> mascotas = (List<Mascota>)request.getAttribute("verMascota");%>  
<!DOCTYPE html >
<html lang="en">
<head>
  	<title>MENU</title>
...
<!-- Header -->
    ...
    <div class="slider-container">
        <div class="mp-slider">
        <br>
        <h2><center>LISTA DE TODOS LOS MASCOTAS</center></h2>
						<table id="t01" class="table">
							...
							<%
								for (int i = 0; i < mascotas.size(); i++) {
									Mascota mascota = (Mascota) mascotas.get(i);
							%>
							<tr>
								<td><%=mascota.getId()%></td>
								<td><%=mascota.getDni_cliente()%></td>
