...
<!-- Header -->
    ...
    <div class="hr-border"></div>
        <div class="a1">
        <h1>En esta ventana usted podra hacer un comentario sobre la atencion recibida en la veterinaria</h1>
        <div>
        <div class="grid_6 alpha">
			...
			<table>
				<tr>
					<td>Comentario *:</td>
					<td><input type="text" name="comentario" required pattern="([a-zA-Záéíóú]+[\s]*[a-zA-Záéíóú]*)" title="Ingrese solo letras"></td>

					<td>Calificacion *:</td>
					<td><input type="text" name="calificacion" maxlength="1"  title="Ingrese solo numeros"></td>
					</tr>
