...
<div class="slider-container">
			<div class="mp-slider">
			<h2><center>HISTORIAS ENCONTRADAS POR EL MEDICO</center></h2>
		<table>
		<tr>
		<td>Medico encargado de las historias:</td>
		<td><input type="text" value="<%= request.getAttribute("medico")%>"></td>
		</tr>
		</table>
		<br>
